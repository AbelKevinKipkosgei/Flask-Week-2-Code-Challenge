...
Revision ID: d8aec124dd8a
Revises: 
Create Date: 2024-10-16 12:00:40.861402
...
def upgrade():
    ...
    op.create_table('episodes_guests',
    sa.Column('episode_id', sa.Integer(), nullable=False),
    sa.Column('guest_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['episode_id'], ['episodes.id'], name=op.f('fk_episodes_guests_episode_id_episodes')),
    sa.ForeignKeyConstraint(['guest_id'], ['guests.id'], name=op.f('fk_episodes_guests_guest_id_guests')),
